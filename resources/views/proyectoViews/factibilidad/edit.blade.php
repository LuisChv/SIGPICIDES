        ...
        <form method="POST" action="{{route('factibilidad.update')}}">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <textarea class="inputArea" rows="5" name="economica" placeholder="Factibilidad económica">{{$factibilidad->economia}}</textarea>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <textarea class="inputArea" rows="5" name="operativa" placeholder="Factibilidad operativa">{{$factibilidad->operativa}}</textarea>
                        </div>
                        <div class="col-md-6">
                            <textarea class="inputArea" rows="5" name="tecnica" placeholder="Factibilidad técnica">{{$factibilidad->tecnica}}</textarea>
                        </div>
                    </div><br>
                    <div class="row">
                        <div class="col-md-6">
                            <textarea class="inputArea" rows="5" name="extra" placeholder="Factibilidad extra">{{$factibilidad->fac_extra}}</textarea>
                        </div>
                    </div>
                    <br>
