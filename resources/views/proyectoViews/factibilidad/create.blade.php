        ...
        <form method="POST" action="{{route('factibilidad.store')}}">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <textarea class="inputArea" rows="5" name="economica" placeholder="Factibilidad económica"></textarea>
                        </div>
                        <div class="col-md-6">
                            <textarea class="inputArea" rows="5" name="financiera" placeholder="Factibilidad financiera"></textarea>
                        </div>
                    </div><br>
                    <div class="row">
                        <div class="col-md-6">
                            <textarea class="inputArea" rows="5" name="operativa" placeholder="Factibilidad operativa"></textarea>
                        </div>
                        <div class="col-md-6">
                            <textarea class="inputArea" rows="5" name="tecnica" placeholder="Factibilidad técnica"></textarea>
                        </div>
                    </div><br>
                    <div class="row">
                        <div class="col-md-6">
                            <textarea class="inputArea" rows="5" name="extra" placeholder="Factibilidad extra"></textarea>
                        </div>
                    </div>
                    <br>
