                    ...
                    <div class="row">                        
                        ...
                        <div class="col-md-6">
                            <div class="input-group{{ $errors->has('miembros') ? ' has-danger' : '' }}">
                                ...
                                <input value="{{ $equipo->miembros }}" required type="number" step="1" name="miembros" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Cantidad de miembros del equipo de investigación.') }}">
                            ...
                            <div class="input-group{{ $errors->has('costo') ? ' has-danger' : '' }}">
                                ...
                                <input value="{{ $proyecto->costo }}" required type="number" step="0.01" name="costo" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Costo (US$)') }}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="input-group{{ $errors->has('duracion') ? ' has-danger' : '' }}">
                                ...
                                <input value="{{ $proyecto->duracion }}" required type="number" step="1" name="duracion" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Duración en días') }}">
