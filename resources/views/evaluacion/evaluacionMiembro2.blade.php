        ...
        <table width="100%">
            <tr>
                <td width="50%" align="left">
                    <a class="btn btn-primary" target="_blank" href="{{ route('proyecto_tareas.index', $solicitud->id_proy)  }}">
                        Ver planificacion
                    </a>
                </td>
            </tr>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">                     
                    <table class="table" style="background-color: white !important;" >
                        <tr>
                            <td><textarea id= "coment" required rows="3" style="color: #222a42 !important;" class="inputArea" maxlength="2000" name="descripcion_objetivo"></textarea></td>
                        </tr>
